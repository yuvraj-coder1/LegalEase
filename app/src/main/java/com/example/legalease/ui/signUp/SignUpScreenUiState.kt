...
data class SignUpScreenUiState(
    ...
    val expertise:List<String> = listOf("Real Estate","Property","Business","Family matters", "Others"),
    val fee:String = "",
    val selectedExpertise:List<String> = listOf(),
    val isThisExpertiseSelected:List<Boolean> = listOf(false,false,false,false, false),
